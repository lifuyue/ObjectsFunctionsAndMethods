...
def try_methods_and_functions():
    solomen = rg.SimpleTurtle()
    solomen.pen = rg.Pen('blue', 5)

    solomen.backward(150)

    solomen.speed = 1
    draw_many_squares(solomen, 2, 100, 30)

    solomen.speed = 5
    solomen.pen.color = 'red'
    draw_many_squares(solomen, 10, 50, 15)

    solomen.speed = 100
    solomen.pen.thickness = 35
    draw_many_squares(solomen, 8, 300, 60)

    solomen.pen = rg.Pen('black', 3)

    solomen.backward(200)

    solomen.draw_circle(30)

    solomen.draw_square(50)
